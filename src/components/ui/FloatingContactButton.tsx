...
export const FloatingCallButton = () => {
    ...
    return (
        ...
        >
            ...
            <div className="w-16 h-16 bg-primary text-[#01358a] rounded-full flex items-center justify-center shadow-[0_15px_30px_rgba(6,182,212,0.4)] hover:scale-110 transition-all duration-300 group-active:scale-95 border-4 border-white">
