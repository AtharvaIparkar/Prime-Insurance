...
export const FloatingWhatsAppButton = () => {
    ...
    const whatsappNumber = '+917420802527'; // Updated number
    const message = encodeURIComponent('Hello! I would like to inquire about insurance services from Prime Insurance Services, Rajgurunagar, Pune.');
    ...
    return (
        <a
            ...
            className="bg-[#25D366] hover:bg-[#20BA5A]
                 ...
                 shadow-[0_15px_30px_rgba(37,211,102,0.4)] hover:shadow-xl
