...
export default function FeedbackPage() {
    return (
        <main className="min-h-screen bg-[#F9FAFB] pt-44 pb-24 px-4">
            <div className="max-w-4xl mx-auto space-y-12">
                <div className="text-center space-y-4">
                    <h2 className="text-[#2563EB] font-black uppercase tracking-[0.4em] text-xs">Share Excellence</h2>
                    <h1 className="text-4xl md:text-6xl font-black text-[#2872A1] tracking-tighter uppercase leading-[1.1]">
                        How was your Journey with Prime?
                    </h1>
