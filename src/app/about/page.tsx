...
export default function AboutPage() {
    return (
        <div className="flex flex-col">
            ...
            <section className="bg-[#2872A1] py-28 relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto space-y-16">
                        ...
                        <ScrollReveal animation="slide-up">
                            <div className="space-y-6 text-lg sm:text-xl text-slate-600 leading-relaxed font-medium">
                                <h2 className="text-3xl sm:text-4xl font-black text-[#2872A1] uppercase tracking-tighter">Strategic Partnerships <br /><span className="text-[#2563EB]">Nationwide</span></h2>
                                <p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            <ScrollReveal animation="slide-left" delay={200}>
                                <div className="bg-[#EEF4FF] p-16 rounded-[4rem] text-[#2872A1] space-y-6 shadow-xl border border-[#D1D9E6] relative overflow-hidden h-full">
                        ...
                        <ScrollReveal animation="fade" threshold={0.2}>
                            <div className="space-y-8 bg-[#EEF4FF] p-12 md:p-16 rounded-[3rem] border border-[#D1D9E6]">
                                <h2 className="text-3xl font-black text-[#2872A1] uppercase tracking-tighter">Why Choose Prime Insurance Consultancy?</h2>
